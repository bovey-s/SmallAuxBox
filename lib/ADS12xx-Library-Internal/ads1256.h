...
#define PGA_1 0x00 //(default)
#define PGA_2 0x01
#define PGA_4 0x02
#define PGA_8 0x03
#define PGA_16 0x04
#define PGA_32 0x05
#define PGA_64 0x06 //also 0x7

/*DIFFERENTIAL PAIR SELECT*/
#define AIN0_AIN1 B00000001 //0x01 
#define AIN2_AIN3 B00100011 //0x23
#define AIN4_AIN5 B01000101 //0x45
#define AIN6_AIN7 B01100111 //0x67
#define AIN0_AIN7 B00000111 //0x07

/*The # of MULTIPLEXER REGISTERS TO CYCLE THROUGH*/
#define CYCLE_2 2
//#define CYCLE_4 4
...
#define		ZERO		0x00	//Shorthand zero
/*DATA READ*/
...
//Note: TCLKIN = 1/fCLKIN = 1 / SPI_SPEED
#define SPI_SPEED 1000000 //Hz (1 MHz) := Osc / 16 (for 16 Mhz) || Osc / 8 (for 8MHz)
#define t11 8 //24*CLK_IN + 5 micros
#define t6 11 //50*CLK_IN + 5 micros
